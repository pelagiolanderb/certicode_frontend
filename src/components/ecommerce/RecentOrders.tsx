...
interface Seminar {
  id: number; // Unique identifier for each product
  name_of_seminar: string; // Product name
  speaker_name: string;
  date: string; // Number of variants (e.g., "1 Variant", "2 Variants")
  participants: number; // Category of the product
  status: "On going" | "Preparing" | "Done"; // Status of the product
}
