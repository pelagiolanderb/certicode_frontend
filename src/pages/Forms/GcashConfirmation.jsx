        ...
        <div className="flex gap-4">
          <div className="flex-1 space-y-3 text-sm">
            ...
            <div>
              ...
              <p className="text-gray-600">Number: {paymentDetails?.accountNumber}</p>
            </div>

            <div>
              <h4 className="font-semibold">Payment Information</h4>
              <p className="text-gray-600">Reference: {paymentDetails?.referenceNumber}</p>
              <p className="text-gray-600">Method: GCash</p>
...
export default GcashConfirmationModal;