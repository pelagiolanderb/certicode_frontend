...
const LandingMain = () => {
  ...
  return (
    <>
      ...
      <section className="relative flex flex-col justify-center items-center text-center p-6 bg-gray-200 max-w-[2200px] w-full mx-auto">
        <img
          src="./img/top_page.png"
          alt="Hero"
          className="absolute top-0 md:left-[20%] z-0
          w-48
          lg:w-155 lg:h-75
          md:w-117 md:h-70                 
          "
        />
        <img
          src="./img/background_page.png"
          alt="Hero"
          className="absolute top-0 md:left-0 z-0
           md:h-full md:w-auto md:block
           hidden
                         
          "
        />
        <img
          src="./img/bottom_page.png"
          alt="Hero"
          className="absolute bottom-0 md:left-[5%] z-1
          md:h-auto h-[50px] left-0
                         
          "
        />
        <div className="flex flex-col md:flex-row items-center justify-center p-4 rounded-lg w-full max-w-7xl mt-10">
          <img
              src="./img/banner_model.png"
              alt="Hero"
              className="w-[45rem] h-[90%] max-h-[90%] relative md:bottom-[-40px] z-1 transition-all duration-300"
            />

          <div className="md:w-2/3 md:text-left text-center px-4 md:text-blue-900 z-10">
            <h2 className="text-6xl font-bold my-10 ">CERTICODE</h2>
            <h3 className="md:text-2xl my-6">Seamless Certificate Creation & Delivery!</h3>
            <p className="mt-4 leading-relaxed">
              Generate professional certificates in seconds, <br className="hidden md:inline-block" />
              automate sending to attendees, and ensure a secure, <br className="hidden md:inline-block"/>
              reliable, and hassle-free experience.
            </p>

            <Link to="/about" className="mt-6 inline-block  md:w-[30%] 
             bg-blue-900 text-white px-6 py-3
             rounded-4xl hover:bg-blue-700 transition-all duration-300">
              Register Now
            </Link>
          </div>
        </div>
        ...
        {/* About Us Section */}
        <motion.section id="about-us" className="relative "
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.2 }}
        variants={fadeIn}
        >
          <div className="flex flex-col items-center text-center space-y-4 my-12">
            ...
            <div className="relative flex items-center h-full flex-col md:flex-row w-full max-w-7xl ">
                {/* Text Section */}
                ...
                {/* vertical curve */}
                  ...
                  <div className="absolute w-2/3 top-0 bottom-0 z-20 transform -skew-x-12 overflow-hidden bg-white hidden md:inline-block"></div>
                


                {/* Image Section */}
                <div className="flex-1 h-full w-full z-10 mt-8 md:mt-0">
                  <img
                    src="./img/about_us_background_img.jpg"
                    alt="About Us"
